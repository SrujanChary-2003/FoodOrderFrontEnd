...
export const useCreateCheckoutSession = () => {
    ...
    const createCheckoutSessionRequest = async (checkoutSessionRequest: CheckoutSessionRequest) => {
        ...
        console.log('Creating checkout session with request:', checkoutSessionRequest); // Logging request
        ...
        if (!response.ok) {
            ...
            console.error('Error response:', errorResponse); // Logging response error
            throw new Error(`Unable to create checkout session: ${errorResponse}`);
        }
